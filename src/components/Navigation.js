...
import Logo from '../assests/ad-logo.svg'
        ...
        <div>
            <div className='max-w-[1200px] m-auto flex p-2 relative  items-center justify-between'>
                ...
                <div className={`flex justify-center items-center ${profile ? 'relative right-[-1000px] duration-300' : ''}`}>
                    ...
                    <NavLink className='px-4 font-bold hover:text-[orange] duration-300' to='/shop'>Shop</NavLink>
                    <NavLink className='px-4 font-bold hover:text-[orange] duration-300' to='/about'>About</NavLink>
                    <NavLink className='px-4 font-bold hover:text-[orange] duration-300' to='/cart'>Cart</NavLink>

                    <div onClick={()=> setProfile(!profile)}>
                    <img src="https://source.unsplash.com/100x100/?portrait" alt="" className="w-12 h-12 cursor-pointer rounded-full dark:bg-gray-500" />
                    </div>
                </div>
            </div>
            ...
            <div className={`p-3 h-full space-y-2 w-60 absolute ${ profile ? 'right-0' : 'right-[-500px]' } duration-500 top-0 bg-white dark:text-gray-100`}>
                    ...
                    <div className="divide-y divide-gray-700">
                        <ul className="pt-2 pb-4 space-y-1 text-sm">
                            ...
                            <li>
                                <NavLink rel="noopener noreferrer" to="/shop" className="flex items-center p-2 space-x-3 rounded-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
                            ...
                            <li>
                                <NavLink rel="noopener noreferrer" to="/cart" className="flex items-center p-2 space-x-3 rounded-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
                            ...
                            <li>
                                <NavLink rel="noopener noreferrer"to="/about" className="flex items-center p-2 space-x-3 rounded-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
